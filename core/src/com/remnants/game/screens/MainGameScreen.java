...
import com.remnants.game.MapFactory;
import com.remnants.game.MapManager;
import com.remnants.game.Entity;
import com.remnants.game.EntityFactory;
import com.remnants.game.Map;
import com.remnants.game.UI.PlayerHUD;
...
public class MainGameScreen extends GameScreen {
	...
	public MainGameScreen(Remnants game){
		_game = game;
	...
	public void render(float delta) {
		if( _gameState == GameState.GAME_OVER ){
			_game.setScreen(_game.getScreenType(Remnants.ScreenType.GameOver));
		}
